...
package com.dhht.sld.main.webview.view;
 ...
 */
@ViewInject(mainLayoutId = R.layout.fragment_webview_explorer)
public class QDWebExplorerFragment extends BaseFragment {
    ...
    @BindView(R.id.topbar) protected
    ...
    private class ProgressHandler extends Handler {
        ...
        private int mDstProgressIndex=0;
