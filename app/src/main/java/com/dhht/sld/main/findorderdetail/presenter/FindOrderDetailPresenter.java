...
public class FindOrderDetailPresenter extends BasePresenter<ReceivingContract.IView> implements ReceivingContract.IPresenter  {

    public FindOrderDetailPresenter(ReceivingContract.IView view) {
        super(view);
    }
