package com.dhht.sld.main.updateapp.download.entity;
...
public class AppUpdate implements Parcelable {
    ...
    public static class Builder {
         ...
         * 默认的更新颜色
         */
        private int updateColor = R.color.appTheme;

        /**
         * 默认的取消更新文本颜色
         */
        private int updateCancelColor = R.color.appTheme;

        /**
         * 默认的更新进度条颜色
         */
        private int updateProgressColor = R.color.appTheme;
